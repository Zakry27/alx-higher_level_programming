#!/usr/bin/python3
"""this Define unittests for models/rectangle.py.
...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittests to test instantiation of Rectangle class."""
...
class TestRectangle_height(unittest.TestCase):
    ...
    def test_None_height(self):
        with self.assertRaisesRegex(TypeError, "height must be int"):
            Rectangle(1, None)
...
class TestRectangle_x(unittest.TestCase):
    ...
    def test_tuple_x(self):
        with self.assertRaisesRegex(TypeError, "x must be intint"):
            Rectangle(1, 2, (1, 2, 3), 2)
