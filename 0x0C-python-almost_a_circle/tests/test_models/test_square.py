...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests to test instantiation of Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests to te int size initialization of the Square class."""

    def test_None_size(self):
        with self.assertRaisesRegex(TypeError, "width must be int"):
            Square(None)
...
class TestSquare_x(unittest.TestCase):
    """Unittests to te int initialization of Square x attribute."""

    def test_None_x(self):
        with self.assertRaisesRegex(TypeError, "x must be int"):
            Square(1, None)
...
class TestSquare_y(unittest.TestCase):
    ...
    def test_None_y(self):
        with self.assertRaisesRegex(TypeError, "y must be int"):
            Square(1, 3, None)
...
class TestSquare_area(unittest.TestCase):
    """Unittests to test the area method of Square class."""
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests to test update args method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests to test to_dictionary method of Square class."""
